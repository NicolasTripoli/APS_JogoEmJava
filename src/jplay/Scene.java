...
public class Scene
{
    ...
    public Vector getTilesFromRect(Point min, Point max)
    {
        ...
        int minLine = max(0, ((int)centerPositionY - Window.getInstance().getHeight()/2)/ tileHeight);
        ...
        do
        {
            ...
            int minColumn = max(0, ((int)centerPositionX - Window.getInstance().getWidth()/2)/ tileWidth);
    ...
    public Vector getTilesFromPosition(Point min, Point max)
    {
        ...
        int line = 0;
        int drawY = - ((int)centerPositionY - Window.getInstance().getHeight()/2);

        do
        {
            ArrayList tileLine = (ArrayList)tileLayer.get(line);

            int drawX = - ((int)centerPositionX - Window.getInstance().getWidth()/2);
