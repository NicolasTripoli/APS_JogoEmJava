 ...
 * @author User
 */
public class SalaMinistroCiencia extends Cenario{
    ...
    private Animation Fase13,Fase14,Fase15,Pergunta3,Resposta1,Resposta2,Resposta3,Resposta4;
    private Mouse mouse;
    private Opcoes opcoes;
    
    public SalaMinistroCiencia(Window janela,int fase, int pontuacao){
        this.janela = janela;
        pref1 = new Scene();
        this.mouse = janela.getMouse();
        this.opcoes = new Opcoes();
        this.Fase13 = new Animation(URL.Animation("Fase13.png"));
        this.Fase14 = new Animation(URL.Animation("Fase14.png"));
        this.Fase15 = new Animation(URL.Animation("Fase15.png"));
        this.Pergunta3 = new Animation(URL.Animation("Pergunta3.png"));
        funEsc();
    ...
    private void mudarCenario(){
        if(tileCollision(8,jogador,pref1) == true){
            new SaguaoPrefeitura(janela,fase,pontuacao,4);
        }
    ...
    private void Respostas() {
        this.Resposta1 = new Animation(URL.Animation("P3R1.png"));
        this.Resposta2 = new Animation(URL.Animation("P3R2.png"));
        this.Resposta3 = new Animation(URL.Animation("P3R3.png"));
        this.Resposta4 = new Animation(URL.Animation("P3R4.png"));
        Resposta1.x = 10;
        Resposta1.y = 240;
        Resposta2.x = 10;
        Resposta2.y = 330;
